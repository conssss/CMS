            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLongTitle">ADD HOMEPAGE INFORMATION</h5>
                  ...
                  @csrf
                   <div class="mb-3">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" name="headhome" placeholder="Input Header Here..." id="head" required>
                    </div>
                    <div class="mb-3">
                      <label for="des" class="form-label" style="margin-right: 380px;font-weight: bold;">Description</label>
                      <input type="text" class="form-control" id="des" name="descriptionhome" placeholder="Type Here..." required>
                    </div>
...
<div class="container" style="margin-top: 20px"> 
    ...
    <div class="row" >
        <table id="tablegg" class="display" style="width:100%; background-color:#CFFF47;">
            <thead>
            <tr>
              
                <th class="text-center">Logo</th>
                <th class="text-center">Head Title</th>
            ...
            <tbody>
                 @foreach ($table as $table)
                    <tr>
                       <td><img src="./salcedo/img/home/{{$table->logo}}" width="100px" height="100px" /></td>
                        <td>{{$table->headhome}}</td>
                        <td>{{$table->descriptionhome}}</td>
                          <td >
                            <a href="" data-toggle="modal" data-target="#editmodal{{$table->id}}"><i class="bi bi-pencil-square bi-lg" aria-hidden="true" style="color: green"></i></a> / 

                            <a href="delhome/{{ $table->id}}"><i class="bi bi-trash3 bi-lg" aria-hidden="true" style="color: red"></i></a></td>
                        @endforeach
                    </tr>
                   @include('edithome')
            </tbody>
...
<footer style="background-color:#CFFF47;"class="fixed-bottom">
    <div class="container">
        <div class="text-center p-2" >
          <img src="http://tarlacfirst.com/wp-content/uploads/san-manuel.png" height="50px"><h5 style="font-size: 13px;font-weight: bold;">© 2022 Copyright Barangay Salcedo</h5>
        </div>
    </div>
</footer>
</html>
