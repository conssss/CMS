            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLongTitle">ABOUT INFORMATION</h5>
                    
                </div>
                <div class="modal-body">

                 <form action="aboutadd" method="post" enctype="multipart/form-data">
                  @csrf
                   <div class="mb-3">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" name="head" placeholder="Input Header Here..." id="head" required>
                    </div>
                    <div class="mb-3">
                      <label for="des" class="form-label" style="margin-right: 350px;font-weight: bold;">Header Body</label>
                      <input type="text" class="form-control" id="des" name="body" placeholder="Type Here..." required>
                    </div>
                    <div class="mb-3">
                      <label for="des" class="form-label" style="margin-right: 350px;font-weight: bold;">Title 1</label>
                      <input type="text" class="form-control" id="des" name="t1" placeholder="Type Here..." required>
                    </div>
                    <div class="mb-3">
                      <label for="des" class="form-label" style="margin-right: 350px;font-weight: bold;">Description 1</label>
                      <input type="text" class="form-control" id="des" name="d1" placeholder="Type Here..." required>
                    </div>
                    <div class="mb-3">
                      <label for="des" class="form-label" style="margin-right: 350px;font-weight: bold;">Title 2</label>
                      <input type="text" class="form-control" id="des" name="t2" placeholder="Type Here..." required>
                    </div>
                    <div class="mb-3">
                      <label for="des" class="form-label" style="margin-right: 350px;font-weight: bold;">Description 2</label>
                      <input type="text" class="form-control" id="des" name="d2" placeholder="Type Here..." required>
                    </div>
                     <div class="mb-3">
                      <label for="des" class="form-label" style="margin-right: 350px;font-weight: bold;">Title 3</label>
                      <input type="text" class="form-control" id="des" name="t3" placeholder="Type Here..." required>
                    </div>
                    <div class="mb-3">
                      <label for="des" class="form-label" style="margin-right: 350px;font-weight: bold;">Description 3</label>
                      <input type="text" class="form-control" id="des" name="d3" placeholder="Type Here..." required>
                    </div>
...
<div class="container" style="margin-top: 20px"> 
    ...
    <div class="row" >
        <table id="tablegg" class="display" style="width:50%; background-color:#CFFF47;">
            <thead>
            <tr>
                <th class="text-center">Picture Bakcground</th>
                <th class="text-center">Header Title</th>
                <th class="text-center">Header Body</th>
                ...
                <th class="text-center">Description 3</th>
           ...
           @foreach ($table as $table)
                    <tr>
                       <td><img src="./salcedo/img/about/{{$table->picture}}" width="100px" height="100px" /></td>
                        <td>{{$table->head}}</td>
                        <td>{{$table->body}}</td>
                        <td>{{$table->t1}}</td>
                        <td>{{$table->d1}}</td>
                        ...
                        <td>{{$table->d3}}</td>
                          <td >
                            <a href="" data-toggle="modal" data-target="#editabout{{$table->id}}"><i class="bi bi-pencil-square bi-lg" aria-hidden="true" style="color: green"></i></a> / 

                            <a href="delabout/{{ $table->id}}"><i class="bi bi-trash3 bi-lg" aria-hidden="true" style="color: red"></i></a></td>
                        @endforeach
                    </tr>
                    @include('editabout')
            </tbody>
