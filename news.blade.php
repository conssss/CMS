            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLongTitle">NEWS INFORMATION</h5>
    ...
    <div class="row" >
        <table id="tablegg" class="display" style="width:50%; background-color:#CFFF47;">
            ...
            @foreach ($table as $table)
                    <tr>
                        <td><img src="./salcedo/img/news/{{$table->picture}}" width="200px" height="100px" /></td>
                        <td>{{$table->header}}</td>
                        <td>{{$table->title}}</td>
                        <td>{{$table->description}}</td>
                          <td ><a href="" data-toggle="modal" data-target="#editnew{{$table->id}}"><i class="bi bi-pencil-square bi-lg" aria-hidden="true" style="color: green"></i></a> / 
                         <a href="delnews/{{ $table->id}}"><i class="bi bi-trash3 bi-lg" aria-hidden="true" style="color: red"></i></a></td>
                        @endforeach
                    </tr>
                    @include('editnews')
            </tbody>
